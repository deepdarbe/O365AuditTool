...
(function (root) {
  ...
  // Precedence step 1 — the exit code. PsExec reports the Win32 code that stopped it, and the
  // code survives the OEM code page mangling that garbles localized endpoint text, so it is a
  // stronger signal than any string match. The network codes mirror the transient list in
